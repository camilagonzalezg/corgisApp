<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Corgis.aspx.cs" Inherits="CorgisApp.Default" %>
...
<body>
    ...
    <form id="form2" runat="server">
        <main class="container-fluid mt-5">
            <div class="row">
                <% String[] corgis = { "paño", "caja", "palta", "chubi" };
                    String[] fotos = {"Imagenes/corgi.jpg","Imagenes/corgi2.jpg",
                        "Imagenes/corgi3.jpg","Imagenes/corgi4.jpg"};
